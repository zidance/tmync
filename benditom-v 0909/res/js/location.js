...
var provinceHtml = '<div class="content"><div data-widget="tabs" class="m JD-stock" id="JD-stock">'
								+'<div class="mt">'
								+'    <ul class="tab">'
								+'        <li data-index="0" data-widget="tab-item" class="curr"><a  class="hover"><em>请选择</em><i></i></a></li>'
								+'        <li data-index="1" data-widget="tab-item" style="display:none;"><a  class=""><em>请选择</em><i></i></a></li>'
								+'        <li data-index="2" data-widget="tab-item" style="display:none;"><a  class=""><em>请选择</em><i></i></a></li>'
								+'        <li data-index="3" data-widget="tab-item" style="display:none;"><a  class=""><em>请选择</em><i></i></a></li>'
								+'    </ul>'
								+'    <div class="stock-line"></div>'
								+'</div>'
								+'<div class="mc" data-area="0" data-widget="tab-content" id="stock_province_item">'
								+'    <ul class="area-list">'
								+'       <li><a  data-value="1">北京</a></li><li><a  data-value="2">上海</a></li><li><a  data-value="3">天津</a></li><li><a  data-value="4">重庆</a></li><li><a  data-value="5">河北</a></li><li><a  data-value="6">山西</a></li><li><a  data-value="7">河南</a></li><li><a  data-value="8">辽宁</a></li><li><a  data-value="9">吉林</a></li><li><a  data-value="10">黑龙江</a></li><li><a  data-value="11">内蒙古</a></li><li><a  data-value="12">江苏</a></li><li><a  data-value="13">山东</a></li><li><a  data-value="14">安徽</a></li><li><a  data-value="15">浙江</a></li><li><a  data-value="16">福建</a></li><li><a  data-value="17">湖北</a></li><li><a  data-value="18">湖南</a></li><li><a  data-value="19">广东</a></li><li><a  data-value="20">广西</a></li><li><a  data-value="21">江西</a></li><li><a  data-value="22">四川</a></li><li><a  data-value="23">海南</a></li><li><a  data-value="24">贵州</a></li><li><a  data-value="25">云南</a></li><li><a  data-value="26">西藏</a></li><li><a  data-value="27">陕西</a></li><li><a  data-value="28">甘肃</a></li><li><a  data-value="29">青海</a></li><li><a  data-value="30">宁夏</a></li><li><a  data-value="31">新疆</a></li><li><a  data-value="32">台湾</a></li><li><a  data-value="42">香港</a></li><li><a  data-value="43">澳门</a></li><li><a  data-value="84">钓鱼岛</a></li>'
								+'    </ul>'
								+'</div>'
	...
	if (result&&result.length > 0){
		for (var i=0,j=result.length;i<j ;i++ ){
			...
			if(result[i].name.length > 12){
				...
				longhtml.push("<li class='long-area'><a  data-value='"+result[i].id+"'>"+result[i].name+"</a></li>");
			}
			else{
